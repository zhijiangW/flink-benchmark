...
/**
 * JMH throughput benchmark runner for pipelined compression scenario.
 */
@OperationsPerInvocation(value = StreamNetworkCompressionThroughputBenchmarkExecutor.RECORDS_PER_INVOCATION)
public class StreamNetworkCompressionThroughputBenchmarkExecutor extends BenchmarkBase {
	...
	public static void main(String[] args) throws RunnerException {
		Options options = new OptionsBuilder()
			...
			.include(".*" + StreamNetworkCompressionThroughputBenchmarkExecutor.class.getSimpleName() + ".*")
			.build();
	...
	@Benchmark
	public void networkPipelinedCompressionThroughput(CompressionEnvironment context) throws Exception {
		context.executeBenchmark(RECORDS_PER_INVOCATION);
	}

	/**
	 * Setup for the pipelined compression benchmark(s).
	 */
	@State(Thread)
